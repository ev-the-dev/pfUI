...
function pfUI:LoadConfig()
  ...
  pfUI:UpdateConfig("buffs",      nil,           "buffgrowth",       "RIGHT_TO_LEFT")
  pfUI:UpdateConfig("buffs",      nil,           "debuffgrowth",     "RIGHT_TO_LEFT")
  pfUI:UpdateConfig("buffs",      nil,           "wepbuffgrowth",    "RIGHT_TO_LEFT")
  ...
  pfUI:UpdateConfig("unitframes", "group",       "growth",           "TOP_TO_BOTTOM")
